...
export default function Getstarted() {
  ...
  return (
    <div className="h-screen w-full bg-white font-sora">
      ...
      <div className="h-[50vh] w-full overflow-hidden flex items-center justify-center">
        <div className="relative w-full h-full">
          <DotLottieReact
            src="https://lottie.host/8932a874-d1e9-4ee1-a4da-3e6f17d51652/aVwzx8uHli.lottie"
            loop
            autoplay
            style={{ position: "absolute", inset: 0, width: "100%", height: "120%", marginTop: "-15%" }}
          />
        </div>
      </div>

      {/* BOTTOM: curved container exactly the other half */}
      <div className="h-[40vh] w-full bg-white-100 rounded-t-[28px] p-6 flex flex-col justify-center items-center">
        <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Your ideal app, Your ideal relationship.</h2>
        <h3 className="text-gray-600 max-w-70 mx-auto leading-relaxed text-sm break-words text-center mb-10">Create a unique emotional story that describes better than words</h3>
